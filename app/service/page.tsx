...
import { Car, Users, Clock, Shield, MapPin, Phone, Star } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Our Services - Drivr | Professional Driver & Chauffeur Services',
  description: 'Explore comprehensive driver services including personal drivers, corporate solutions, airport transfers, event transportation, and on-demand drivers. Professional, vetted chauffeurs for all your needs.',
  keywords: ['driver services', 'chauffeur service', 'personal driver hire', 'corporate driver solutions', 'airport transfer', 'event transportation', 'on-demand driver', 'professional driver rental'],
  openGraph: {
    title: 'Our Services - Drivr | Professional Driver & Chauffeur Services',
    description: 'Explore comprehensive driver services including personal drivers, corporate solutions, airport transfers, event transportation, and on-demand drivers. Professional, vetted chauffeurs for all your needs.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Our Services - Drivr | Professional Driver & Chauffeur Services',
    description: 'Professional driver services for personal, corporate, and event transportation needs. Book vetted chauffeurs today.',
  },
  robots: {
    index: true,
    follow: true,
